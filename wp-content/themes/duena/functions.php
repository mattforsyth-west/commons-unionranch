...
/* Add Widget Areas to Careers Page ----------- */
function careers_widget1_init() {
	
	register_sidebar(array(
		
		'name'=>'Careers Overview Widget Area 1',
		'id'=>'careers_overview_widget_area_1',
		'before_widget'=>'<div>',
		'after_widget'=>'</div>',
		'before_title'=>'<h2>',
		'after_title'=>'</h2>'
...
function careers_widget2_init() {
	
	register_sidebar(array(
		
		'name'=>'Careers Overview Widget Area 2',
		'id'=>'careers_overview_widget_area_2',
		'before_widget'=>'<div>',
		'after_widget'=>'</div>',
		'before_title'=>'<h2>',
		'after_title'=>'</h2>'
...
add_action('widgets_init','careers_widget1_init');
add_action('widgets_init','careers_widget2_init');