    ...
    ?>
<!-- Hero Mobile Placeholder ----------------------------- Begin -->
<div class="mobile-hero-image visible-xs">
	<img src="/wp-content/uploads/2014/08/huge-home.slide1_.jpg" />
</div>
<!-- Hero Mobile Placeholder ----------------------------- End -->
<div class="flexslider hidden-xs">
    ...
    ?>
        <li>
            ...
            ?>
                <div class="slider-caption col-md-4">
                    <?php 
